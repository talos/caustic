...
public final class PersistedMultiTableDatabase implements PersistedDatabase {
	...
	private String getResultTableName(Scope scope)  throws DatabaseReadException {
	...
	public PersistedMultiTableDatabase(IOConnection connection, ScopeFactory idFactory) {
	...
	@Override
	public void insertOneToOne(Scope id, String name)
			throws DatabasePersistException {
		insertOneToOne(id, name, null);
	}

	@Override
	public void insertOneToOne(Scope scope, String name, String optValue)
			throws DatabasePersistException {
		synchronized(connection) {
