...
class SingleTable {	
	...
	public static void insert(WritableTable table,
			Scope scope, Scope optSource, String name, String optValue) throws TableManipulationException {
	...
	public static void replace(IOTable table,
			Scope scope, Scope optSource, String name, String optValue) throws DatabasePersistException {
	 ...
	 */
	public static String select(IOTable table, Scope scope, String name) throws DatabaseReadException {
		...
		for(Map<String, String> row : rows) {
			if(row.get(NAME_COLUMN_NAME).equals(name)) {
				...
				sourceId = new SerializedScope(row.get(SOURCE_COLUMN_NAME));
			}
		}
