...
import com.invisiblearchitecture.scraper.SQLiteInterface.CursorInterface;

public class SQLiteInformationFactory implements InformationFactory {
	...
	private final SQLiteInterface sqlInterface;
	
	/* Keep a single cookie store for the whole information factory. */
	private final CookieStoreInterface cookieStore;
	private int count = 0;
	
	public SQLiteInformationFactory(SQLiteInterface sqlInt,
			Collector c, Publisher p, HttpInterface httpInt,
			RegexInterface regexInt, LogInterface l) throws Exception {
	 ...
	 * @return
	 */
	private String[] parentInformationTypes (String type) throws Exception {
	 ...
	 * @return
	 */
	private String[] parentNamespaces (String namespace) throws Exception {
	 ...
	 * @throws SQLException 
	 */
	private String[] simpleRecursiveQuery(String sqlBefore, String initialValue, String sqlAfter, String parentColumnName) throws Exception {
	...
	private String[] fieldsToPublish (String[] types) throws Exception {
