...
public interface JSONInterfaceObject {
	...
	//public abstract JSONInterfaceArray getJSONArray(String[] path) throws JSONInterfaceException;
	
	public abstract JSONInterfaceObject getJSONObject(String name) throws JSONInterfaceException, IOException;
	//public abstract JSONInterfaceObject getJSONObject(String[] path) throws JSONInterfaceException;
	...
	//public abstract String getString(String[] path) throws JSONInterfaceException;

	public abstract int getInt(String name) throws JSONInterfaceException;
	//public abstract int getInt(String[] path) throws JSONInterfaceException;
