...
import net.microscraper.client.impl.SQLInterface;
	...
	public MicroScraperConsole(String[] args) {
		try {
			if(args.length < 1) {
				...
				try {
					SQLInterface sql_interface = new JDBCSQLite("./" + DateFormat.getTimeInstance() + ".sqlite");
